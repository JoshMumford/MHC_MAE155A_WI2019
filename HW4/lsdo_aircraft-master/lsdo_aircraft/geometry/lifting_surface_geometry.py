...
class LiftingSurfaceGeometry(OptionsDictionary):
    ...
    def initialize(self):
        ...
        self.declare('wetted_area', default=1., types=float_types)
        self.declare('area', default=1., types=float_types)
        self.declare('aspect_ratio', default=8., types=float_types)
        self.declare('mac', default=0.25, types=float_types)
        ...
        self.declare('characteristic_length', default=3., types=float_types)
        self.declare('inscidence_angle', default=0., types=float_types)
